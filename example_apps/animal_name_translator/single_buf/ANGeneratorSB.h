...
public:
    ANGeneratorSB(const std::string& name, std::map<std::string, std::string>& animalNames, int runs=1, int execDelay=0, int rwDelay=0,
                  int prodRate=1, int consRate=1): ANGenerator(name, animalNames, runs,execDelay, rwDelay, prodRate, consRate){};
